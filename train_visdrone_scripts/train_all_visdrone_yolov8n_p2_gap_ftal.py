#!/usr/bin/env python3
"""Train VisDrone2019 dataset using the GAP + FTAL model layout."""
...
def train(args: argparse.Namespace, data_yaml: Path, seed: int) -> None:
    ...
    run_name = f"visdrone_yolov8n_p2_gap_ftal_seed{seed}"
    ...
    model.val(iou=0.5, split="val")

    print("Evaluating test set (NMS IoU = 0.5)...")
    model.val(iou=0.5, split="test")
...
def main() -> None:
    ...
    parser.add_argument("--project", type=Path, default=ROOT / "runs/visdrone_yolov8n_p2_gap_ftal")
