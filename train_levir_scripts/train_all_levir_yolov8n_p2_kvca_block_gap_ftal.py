#!/usr/bin/env python3
"""Train, evaluate, and upload seed-42 YOLOv8n P2 KVCA block + GAP (before vs after) + FTAL (oldnorm vs newnorm) experiments."""
...
EXPERIMENT = "levir_yolov8n_p2_kvca_block_gap_ftal"
HF_REPO = "duyle2408/levir-yolov8n-p2-kvca-block-gap-ftal-seed42"

CONFIG_AFTER = ROOT.parent / "models_related/models_config/yolov8/levir/yolov8n_p2_fpn_only_kvca_block_gap_after.yaml"
CONFIG_BEFORE = ROOT.parent / "models_related/models_config/yolov8/levir/yolov8n_p2_fpn_only_kvca_block_gap_before.yaml"

VARIANTS = {
    "kvca_block_gap_after_ftal_oldnorm": CONFIG_AFTER,
    "kvca_block_gap_after_ftal_newnorm": CONFIG_AFTER,
    "kvca_block_gap_before_ftal_oldnorm": CONFIG_BEFORE,
    "kvca_block_gap_before_ftal_newnorm": CONFIG_BEFORE,
}
...
def main() -> None:
    ...
    for seed in args.seeds:
        for variant in args.variants:
            workflow.CONFIG = VARIANTS[variant]
