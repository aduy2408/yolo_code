#!/usr/bin/env python3
"""Train, evaluate, and upload official single-head YOLOv9t baseline without OACP or Mosaic on LEVIR-Ship."""
...
EXPERIMENT = "levir_yolov9t_no_oacp_no_mosaic"
VARIANT = "yolov9t_no_oacp_no_mosaic_seed42"
HF_REPO = "duyle2408/levir-yolov9t-no-oacp-no-mosaic-seed42"
...
def run(args: argparse.Namespace) -> None:
    ...
    os.environ["YOLO_CONTEXT_AUG"] = "none"
    local_ultralytics()
    from ultralytics import YOLO
    ...
    (run_dir / "manifest.json").write_text(json.dumps({
        ...
        "augmentation": "none", "model_source": "yolov9t.pt", "commit_sha": subprocess.check_output(
