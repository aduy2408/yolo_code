#!/usr/bin/env python3
"""Train, evaluate, and upload seed-42 YOLOv8n P2 KVCA on Backbone + GAP + FTAL (oldnorm) experiments."""
...
EXPERIMENT = "levir_yolov8n_p2_kvca_backbone_gap_ftal"
HF_REPO = "duyle2408/levir-yolov8n-p2-kvca-backbone-gap-ftal-seed42"
CONFIG = ROOT.parent / "models_related/models_config/yolov8/levir/yolov8n_p2_fpn_only_kvca_backbone_gap.yaml"

VARIANTS = {
    "kvca_backbone_gap_ftal_oldnorm": CONFIG,
}
