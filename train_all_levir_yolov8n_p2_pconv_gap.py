#!/usr/bin/env python3
"""Train/evaluate/upload seed-42 PConv P2 factorized TAL target variants."""
...
import train_all_levir_yolov8n_p2_gap_factorized_tal as base_tal

ROOT = Path(__file__).resolve().parent
CONFIG = ROOT / "models_related/models_config/yolov8/levir/yolov8n_p2_levir_pconv_gap.yaml"

# Override base CONFIG
base.CONFIG = CONFIG

VARIANTS = {
    "pconv_factorized_k15": {
...
DEFAULT_VARIANTS = ("pconv_factorized_k15",)
REQUIRED = base_tal.REQUIRED
...
def write_metadata(variant: str, run_dir: Path, seed: int, args: argparse.Namespace) -> None:
    ...
    manifest = {
        ...
        "topology": "P2 -> C2f_PConv -> GAP ChannelAttention -> shared Detect",
        "detect_from": head.f,
...
class Uploader(base_tal.Uploader):
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--project", type=Path, default=ROOT / "runs/levir_yolov8n_p2_pconv_gap")
    ...
    parser.add_argument("--hf-repo-id", default="duyle2408/levir-yolov8n-p2-pconv-gap-factorized-tal-seed42")
