#!/usr/bin/env python3
"""Train/evaluate Plain (No GAP) + FTAL GGCF candidate-field experiments."""
...
CONFIG = ROOT.parent / "models_related/models_config/yolov8/levir/yolov8n_p2_fpn_only_plain_ggcf.yaml"

workflow.EXPERIMENT = "levir_yolov8n_p2_plain_ftal_ggcf"
workflow.HF_REPO = "duyle2408/levir-yolov8n-p2-plain-ftal-ggcf"
workflow.VARIANTS = {
