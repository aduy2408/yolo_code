...
async def main():
    ...
    # 3. Launch training for ALL variants
    cmd = [
        "python3",
    ...
    print("Launching all variants training sequentially:")
    print(" ".join(cmd))
    ...
    print(f"All-variants training started in background with PID: {proc.pid}")
