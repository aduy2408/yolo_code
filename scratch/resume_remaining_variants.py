...
async def main():
    ...
    # 2. Stop existing training process if any (check PID)
    ...
    # We do NOT remove run_dir to allow resuming C2 post-evaluation and proceed to C3/C4
    ...
    print("Resuming/Launching remaining variants sequentially (C2, C3, C4):")
    print(" ".join(cmd))
    ...
    log_file = open(log_path, "a", encoding="utf-8") # open in append mode
