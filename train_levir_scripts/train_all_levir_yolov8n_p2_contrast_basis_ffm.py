#!/usr/bin/env python3
"""Train/evaluate LEVIR P2 local-contrast-basis with FFM fusion."""
...
EXPERIMENT = "levir_yolov8n_p2_contrast_basis_ffm"
HF_REPO = "duyle2408/levir-yolov8n-p2-contrast-basis-ffm"
PLAIN_YAML = ROOT.parent / "models_related/models_config/yolov8/levir/yolov8n_p2_fpn_only_plain.yaml"
VARIANTS = {
    "contrast_basis_ffm": CONFIG_ROOT / "yolov8n_p2_contrast_basis_ffm.yaml",
}
