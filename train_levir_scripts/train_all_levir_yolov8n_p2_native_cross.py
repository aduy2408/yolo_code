#!/usr/bin/env python3
"""Train, evaluate, summarize, and upload the YOLOv8n P2 Native Cross-Reconstruction models."""
...
EXPERIMENT = "levir_yolov8n_p2_native_cross"
HF_REPO = "duyle2408/levir-yolov8n-p2-native-cross-seed42"
VARIANTS = {
    "native_concat": ROOT.parent / "models_related/models_config/yolov8/levir/yolov8n_p2_native_concat.yaml",
    "native_ffm": ROOT.parent / "models_related/models_config/yolov8/levir/yolov8n_p2_native_ffm.yaml",
}
