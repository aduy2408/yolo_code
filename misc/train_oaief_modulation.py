#!/usr/bin/env python3
"""Train, evaluate, and upload matched multiplicative OAIEF ablations."""
...
EXPERIMENTS={"M1":CFG/"yolov8n_p2_levir_oaief_m_elementwise.yaml","M2":CFG/"yolov8n_p2_levir_oaief_m_spatial.yaml","M3":CFG/"yolov8n_p2_levir_oaief_m_channel.yaml"}
