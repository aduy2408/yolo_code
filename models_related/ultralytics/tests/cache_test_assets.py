...
import torch
from models_related.ultralytics.ultralytics.utils import ARM64, ASSETS_URL, DATASETS_DIR, IS_RASPBERRYPI, LINUX, LOGGER, WEIGHTS_DIR

sys.path.insert(0, str(Path(__file__).resolve().parents[1]))
from models_related.ultralytics.tests import MODEL, SOLUTION_ASSETS
from models_related.ultralytics.ultralytics.cfg import TASK2CALIBRATIONDATA, TASK2DATA, TASK2MODEL
...
from models_related.ultralytics.ultralytics.utils.downloads import attempt_download_asset, safe_download
