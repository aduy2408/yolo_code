#!/usr/bin/env python3
"""Train, evaluate, and upload matched selective residual OAIEF ablations."""
...
EXPERIMENTS={"S1":CFG/"yolov8n_p2_levir_selective_spatial.yaml","S2":CFG/"yolov8n_p2_levir_selective_elementwise.yaml"}
