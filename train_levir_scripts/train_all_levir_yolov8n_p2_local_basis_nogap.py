#!/usr/bin/env python3
"""Train/evaluate/upload LBD variants without GAP or FTAL."""
...
EXPERIMENT = "levir_yolov8n_p2_local_basis_nogap"
HF_REPO = "duyle2408/levir-yolov8n-p2-local-basis"
CONFIG_ROOT = ROOT.parent / "models_related/models_config/yolov8/levir"
VARIANTS = {
    "lbd_fixed_nogap": CONFIG_ROOT / "yolov8n_p2_fpn_only_lbd_fixed_nogap.yaml",
    "lbd_adaptive_nogap": CONFIG_ROOT / "yolov8n_p2_fpn_only_lbd_adaptive_nogap.yaml",
}
...
def train_kwargs(args: argparse.Namespace, data_yaml: Path, seed: int, amp: bool) -> dict[str, object]:
    ...
    kwargs["factorized_tal_target"] = False
    return kwargs
