...
def solution_assets():
    ...
    from models_related.ultralytics.tests import SOLUTION_ASSETS
    from models_related.ultralytics.ultralytics.utils import ASSETS_URL, WEIGHTS_DIR
...
def pytest_sessionstart(session):
    ...
    """
    from models_related.ultralytics.ultralytics.utils.torch_utils import init_seeds
