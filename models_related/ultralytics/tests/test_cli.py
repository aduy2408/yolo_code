...
from models_related.ultralytics.tests import CUDA_DEVICE_COUNT, CUDA_IS_AVAILABLE, MODELS, TASK_MODEL_DATA
...
from models_related.ultralytics.ultralytics.utils import ARM64, ASSETS, DATASETS_DIR, IS_RASPBERRYPI, LINUX, WEIGHTS_DIR
...
def test_fastsam(
    ...
    from models_related.ultralytics.ultralytics.models.sam import Predictor
