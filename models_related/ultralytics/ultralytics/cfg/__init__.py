...
CFG_FLOAT_KEYS = frozenset(
    {  # integer or float arguments, i.e. x=2 and x=2.0
        ...
        "scale_temper_s1",
        "scale_temper_s2",
        "scale_temper_tau_min",
        "scale_temper_lambda",
        "factorized_tal_tau",
        "factorized_tal_kappa",
        "factorized_tal_lambda",
        "factorized_tal_s_max",
        "factorized_support_gain",
        "factorized_support_tau",
        "factorized_support_kappa",
        "factorized_support_blend",
        "factorized_support_s_max",
...
CFG_FRACTION_KEYS = frozenset(
    {  # fractional float arguments with 0.0<=values<=1.0
        ...
        "viewport_p",
        "viewport_translate",
        "viewport_min_visibility",
        "occlusion_p",
        "occlusion_object_prob",
        "occlusion_min",
        "occlusion_max",
        "resolution_p",
...
CFG_CHOICE_KEYS = {
    ...
    "factorized_tal_mode": {"legacy", "current", "mass_preserve", "geometry", "agreement_gate"},
...
CFG_INT_KEYS = frozenset(
    {  # integer-only arguments
        ...
        "scale_temper_warmup_start",
        "scale_temper_warmup_end",
        "factorized_tal_warmup_start",
        "factorized_tal_warmup_end",
