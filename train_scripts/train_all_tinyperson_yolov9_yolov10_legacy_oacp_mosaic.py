...
def main(argv=None):
    ...
    from train_scripts.train_all_tinyperson import prepare_test_set, prepare_seed_dataset, evaluate
    from train_scripts.train_all_tinyperson_yolo_baselines import Uploader
