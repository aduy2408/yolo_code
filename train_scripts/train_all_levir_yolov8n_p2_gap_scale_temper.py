...
def raw_p2_rows(run_dir: Path, args: argparse.Namespace) -> list[dict]:
    local_ultralytics()
    from train_scripts.train_levir_scripts import analyze_p2_cbam_ranking as ranking
    ...
    ns = argparse.Namespace(imgsz=args.imgsz, device=device, expected_seed=int(run_dir.name.rsplit("_", 1)[1]))
