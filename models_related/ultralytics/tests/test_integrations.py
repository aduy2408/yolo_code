...
from models_related.ultralytics.ultralytics import YOLO, download
from models_related.ultralytics.ultralytics.utils import ASSETS_URL, DATASETS_DIR, SETTINGS
...
def test_faster_coco_eval():
    ...
    from models_related.ultralytics.ultralytics.models.yolo.pose import PoseValidator
