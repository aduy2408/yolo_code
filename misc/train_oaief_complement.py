#!/usr/bin/env python3
"""Train, evaluate, and upload matched complementary evidence ablations."""
...
ROOT=Path(__file__).resolve().parents[1]; ULTRALYTICS=ROOT/"models_related/ultralytics"; CFG=ROOT/"models_related/models_config/yolov8/levir"
EXPERIMENTS={"C1":CFG/"yolov8n_p2_levir_complement_predictable.yaml","C2":CFG/"yolov8n_p2_levir_complement_hard_negative.yaml","C3":CFG/"yolov8n_p2_levir_complement_retrieval.yaml"}
